...
import com.example.petprojecteshopspringboot2.endpoint.GreetingEndpoint;
import com.example.petprojecteshopspringboot2.endpoint.ProductsWSEndpoint;
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition productsWsdlDefinition() {
        ...
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace(ProductsWSEndpoint.NAMESPACE_URL);
